    ...
    >
      <Link href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
        ...
        <div style={{ width: 30, height: 30, borderRadius: "50%", background: "#fff", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
          <img src="/icon.png" alt="cinnamonrolls.nyc" style={{ width: 22, height: 22, objectFit: "contain" }} />
        </div>
        <div style={{ fontFamily: "var(--font-inter), -apple-system, sans-serif" }}>
          ...
          <div className="header-tagline" style={{ fontWeight: 400, color: "rgba(255,248,240,0.88)", letterSpacing: "0.01em", lineHeight: 1.2, marginTop: 2 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 24, fontFamily: "var(--font-inter), -apple-system, sans-serif" }}>
        {backLink && (
          <Link href="/" className="back-to-map" style={{ fontSize: "13px", color: "rgba(255,248,240,0.88)", textDecoration: "none", fontWeight: 500 }}>
            ← Back to map
          </Link>
        )}
        <div style={{ textAlign: "right" }}>
          ...
          <div className="header-sub" style={{ color: "rgba(255,248,240,0.88)", marginTop: 2, lineHeight: 1.2, whiteSpace: "nowrap" }}>
            Updated today
          </div>
        </div>
      </div>
